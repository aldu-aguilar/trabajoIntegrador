...
const sucursales = {
    index:function(req, res) {
        res.write('Listado de nuestras sucursales: \n');
   ...
   id:function(req, res){
        ...
        if(sucursal.sucursal == idSucursales){
            ...
            res.write('Contamos con esta cantidad de vehiculos: ' + sucursal.autos.length + '\n')
       ...
       // res.send('Error. No encontramos la sucursal')
        })
        res.send('Error. No encontramos la sucursal')
